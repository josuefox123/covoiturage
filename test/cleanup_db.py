...
HOSTNAME = secrets.get("DEPLOY_HOSTNAME", "")
PORT     = int(secrets.get("DEPLOY_PORT", 22))
USERNAME = secrets.get("DEPLOY_USERNAME", "")
PASSWORD = secrets.get("DEPLOY_PASSWORD", "")
REMOTE   = f"/home/{USERNAME}/zemy/backend" if USERNAME else "zemy/backend"
