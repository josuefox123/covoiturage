...
rules_to_test = [
    ("RULE 1: ws://127.0.0.1:8014/$1", """DirectoryIndex disabled
<IfModule mod_rewrite.c>
RewriteEngine On
RewriteBase /
RewriteRule ^(media|static)(/.*)?$ - [L]
RewriteRule ^(ws/.*)$ ws://127.0.0.1:8014/$1 [P,L]
RewriteRule ^(api/ws/.*)$ ws://127.0.0.1:8014/$1 [P,L]
RewriteRule ^api/(.*)$ http://127.0.0.1:8014/api/$1 [P,L]
RewriteRule ^(.*)$ http://127.0.0.1:3001/$1 [P,L]
</IfModule>"""),

    ("RULE 2: http://127.0.0.1:8014/$1 with RequestHeader Upgrade", """DirectoryIndex disabled
...
RewriteBase /
RewriteRule ^(media|static)(/.*)?$ - [L]
RewriteRule ^(ws/.*)$ http://127.0.0.1:8014/$1 [P,L]
RewriteRule ^(api/ws/.*)$ http://127.0.0.1:8014/$1 [P,L]
RewriteRule ^api/(.*)$ http://127.0.0.1:8014/api/$1 [P,L]
RewriteRule ^(.*)$ http://127.0.0.1:3001/$1 [P,L]
</IfModule>"""),

    ("RULE 3: RewriteCond %{HTTP_UPGRADE} + ws://", """DirectoryIndex disabled
<IfModule mod_rewrite.c>
RewriteEngine On
RewriteBase /
RewriteRule ^(media|static)(/.*)?$ - [L]
