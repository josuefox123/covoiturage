...
rules = [
    ("VARIANT 1: ws://localhost:8014/ws/$1", """DirectoryIndex disabled
<IfModule mod_rewrite.c>
RewriteEngine On
RewriteBase /
RewriteRule ^(media|static)(/.*)?$ - [L]
RewriteCond %{HTTP:Upgrade} websocket [NC]
RewriteRule ^ws/(.*)$ ws://localhost:8014/ws/$1 [P,L]
RewriteRule ^api/(.*)$ http://127.0.0.1:8014/api/$1 [P,L]
RewriteRule ^(.*)$ http://127.0.0.1:3001/$1 [P,L]
</IfModule>"""),

    ("VARIANT 2: http://127.0.0.1:8014/ws/$1 with Upgrade cond", """DirectoryIndex disabled
<IfModule mod_rewrite.c>
RewriteEngine On
RewriteBase /
RewriteRule ^(media|static)(/.*)?$ - [L]
...
RewriteRule ^(.*)$ http://127.0.0.1:3001/$1 [P,L]
    ...
    ("VARIANT 3: ws://127.0.0.1:8014/$1 (no /ws/ prefix)", """DirectoryIndex disabled
<IfModule mod_rewrite.c>
RewriteEngine On
RewriteBase /
RewriteRule ^(media|static)(/.*)?$ - [L]
