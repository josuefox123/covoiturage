...
_, stdout, _ = client.exec_command("grep -i -C 2 -E 'reject|fail|error|403|disconnect|400' /home/ewnhmjym/zemy/logs/backend.log | tail -n 100")
print("=== ERRORS/REJECTS IN DAPHNE LOG ===")
