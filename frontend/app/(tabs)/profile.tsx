...
export default function ProfileScreen() {
  ...
  // Password reset functions and render helpers
  ...
  useEffect(() => {
    ...
    if (passwordModalVisible && pwdStep === 2 && pwdResendTimer > 0) {
  ...
  }, [passwordModalVisible, pwdStep, pwdResendTimer]);
