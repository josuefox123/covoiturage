...
const styles = StyleSheet.create({
  ...
  tripTypeTxt: { fontSize: 11, fontWeight: '600', color: '#6B7280' },
  tripTypeTxtActive: { color: '#FFFFFF' },
  ...
  inputPlaceholder: { fontSize: 14, color: '#C4C9D4', fontWeight: '500' },
  inputValue: { fontSize: 14, color: '#1F2937', fontWeight: '600' },
  ...
  swapLine: { flex: 1, height: 1, backgroundColor: '#E5E7EB', marginRight: 10 },
  swapBtn: {
  ...
  metaCellText: { flex: 1 },
  metaLabel: { fontSize: 9, color: '#9CA3AF', fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.4 },
  metaValue: { fontSize: 12, color: '#1F2937', fontWeight: '700', marginTop: 1 },
  metaVDivider: { width: 1, backgroundColor: '#E5E7EB', marginVertical: 6 },
